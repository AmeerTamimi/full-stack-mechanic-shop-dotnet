            ...
            col.Item().Row(row =>
            {
                row.RelativeItem(1).Element(container =>
                {
                    container.Row(logoRow =>
                    {
                        ...
                        {
                            text.Span("A").FontColor(Colors.Cyan.Lighten3).FontSize(24).Bold();
                            text.Span("M").FontColor(Colors.Orange.Medium).FontSize(24).Bold();
                            text.Span("E").FontColor(Colors.Yellow.Medium).FontSize(24).Bold();
                            text.Span("E").FontColor(Colors.Green.Medium).FontSize(24).Bold();
                            text.Span("R").FontColor(Colors.Blue.Lighten2).FontSize(24).Bold();
                            text.Span(" ").FontSize(24);
                            text.Span("S").FontColor(Colors.Red.Lighten2).FontSize(24).Bold();
                            text.Span("H").FontColor(Colors.Purple.Medium).FontSize(24).Bold();
                            text.Span("O").FontColor(Colors.Brown.Medium).FontSize(24).Bold();
                ...
                row.RelativeItem(1).AlignRight().Column(detailsCol =>
                {
                    ...
                    detailsCol.Item().PaddingTop(5).Text($"Date: {invoice.IssuedAt:MMMM dd, yyyy}")
                        .FontSize(12)
            ...
            col.Item().PaddingTop(30).Row(row =>
            {
                ...
                row.RelativeItem(1).Column(totalsCol =>
                {
                    ...
                    totalsCol.Item().PaddingVertical(5).Row(totalRow =>
                    {
                        ...
                        totalRow.RelativeItem().AlignRight().Text($"{invoice.Tax:C}").FontSize(11).FontColor(Colors.Grey.Darken3);
                    });
                    ...
                    if (invoice.Discount > 0)
                    {
                        totalsCol.Item().PaddingVertical(5).Row(totalRow =>
                        {
                            ...
                            totalRow.RelativeItem().AlignRight().Text($"-{invoice.Discount:C}").FontSize(11).FontColor(Colors.Red.Medium);
                        });
                    }

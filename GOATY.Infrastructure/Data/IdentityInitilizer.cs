...
namespace GOATY.Infrastructure.Data
{
    public sealed class IdentityInitilizer
    {
        ...
        private readonly ILogger<IdentityInitilizer> _logger;
        public IdentityInitilizer(UserManager<AppUser> userManager,
                                  RoleManager<IdentityRole> roleManager,
                                  AppDbContext context,
                                  ILogger<IdentityInitilizer> logger)
    ...
    public static class InitializerExtensions
    {
        public static async Task InitilizedDatabaseAsync(this WebApplication app)
        {
            ...
            var initialiser = scope.ServiceProvider.GetRequiredService<IdentityInitilizer>();
